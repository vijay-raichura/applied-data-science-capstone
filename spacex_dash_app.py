...
dropdown_options.extend([{'label': i, 'value': i} for i in spacex_df['Launch Site'].unique()])
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df['freq'] = filtered_df.groupby('class')['class'].transform('count')
        
        fig = px.pie(filtered_df, values='freq', 
        names='class', 
